...
export const Profile = () => {
  return (
    ...
    <div className="profile_photo">
        <h5 className="profile_update"> Your Photo<span className="para_profile_update"><br></br>This will be displayed on your Profile</span></h5>
        <div className="profile-image-container">
                <img src={profileImage} className="myaccount-profile-image" />
            </div>
                
        <div className="update_button_div">
        <Button variant="primary" className="btn btn-sm update_button">Update </Button>
</div>
</div>
<hr className="website_hr"></hr> 
<div className="profile_bio">
<h5 className="profile_update_bio"> Your bio<span className="para_profile_update_bio"><br></br>Write a Short Introduction</span></h5>
...
<h5 className="password-change-label">Change Password:</h5>
            ...
            <h6 className="profile-current-password-label">Enter current password:</h6>
            ...
            <h6 className="profile-retype-password-heading">Retype new password:</h6>
            <br />
            <input type="password" className="profile-retype-password" />
            </div>
            <br /><br />
            <Button variant="primary" className="btn btn-sm password_button">Update Password</Button>
